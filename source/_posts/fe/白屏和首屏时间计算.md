...
<body>
  <img src="https://image.chenhanpeng.com/static/blog-images/blogImages/2021/spring/20210107155629.png" alt="img" onload="load()">
  <img src="https://image.chenhanpeng.com/static/blog-images/blogImages/2020/autumn/article-gzh-qrcode.png" alt="img" onload="load()">
  <script>
    function load() {
      window.firstScreen = Date.now()
    }
...
![](https://image.chenhanpeng.com/static/blog-images/blogImages/2020/20201113233024.png)
